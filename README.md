...
An immersive static portfolio for an urban planner and public-sector researcher. The site uses semantic HTML, modern CSS, and vanilla JavaScript and is designed for GitHub Pages at `/morenike-living-atlas/`.
...
- **Background image:** replace `assets/living-city-atlas.png` while keeping the filename, or update its relative path in `styles.css`.
